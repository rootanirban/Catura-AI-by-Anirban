...
@app.get("/ping")
def ping():
    return {"status": "ok", "timestamp": datetime.utcnow().isoformat(), "version": "0.0.212"}
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "version": "0.0.212", "timestamp": datetime.utcnow().isoformat()}
    ...
    try:
        ...
        system_prompts = {
            ...
            "kimi": (
                ...
                "You are Catura AI Kimi, specialising in deep reasoning and complex analysis. "
